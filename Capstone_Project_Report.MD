...
First, a baseline in performance will be done using a robust method such as Logistic Regression. Next, XGBoost and LightGBM models are good supervised learning approaches that will be explored next. 
